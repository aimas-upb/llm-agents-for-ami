...
open class AgentConfiguration {
    ...
    @Bean
    open fun userAssistantAgent(agents: Agents, environment: Environment): Agent<*, *> {
        ...
        log.info("Configuring user-assistant-agent to use model client '{}' ({})", modelId, providerDetails)
