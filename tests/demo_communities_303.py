...
async def main():
    ...
    sequence = "demo" # _resolve_sequence(args)
    ...
    explorer = EnvExplorerAgent(explorer_jid, password, env_config, hmas_client=DummyHMASClient(), integration_port=8093) # 303
    # explorer = EnvExplorerAgent(explorer_jid, password, env_config, hmas_client=DummyHMASClient(), integration_port=8098) # 308
